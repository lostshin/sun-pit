...
目前工作樹是 `2.19.1` 候選版。名稱、定位、繁中／英文文案與素材清單統一維護在 [商店文案](../assets/store/LISTING.md)。歷史版本資料保留在 `assets/store/publish-v2.4.0/` 與 `publish-v2.4.2/`，不作為新版送審內容。
...
| 檔案 | 用途 |
| --- | --- |
| `dist/sun-pit-v2.19.1.zip` | Chrome Web Store 與 GitHub 手動安裝 |
| `dist/sun-pit-helper-v2.19.1-macos.zip` | 另行安裝的 macOS Native Helper |
...
2. 建立新的 `v2.19.1` Release，確認兩個 ZIP 與 checksum 可下載；不改動既有公開 tag。
