...
ARCHIVE="${OUTPUT_DIR}/sun-pit-v${VERSION}.zip"
HELPER_ARCHIVE="${OUTPUT_DIR}/sun-pit-helper-v${VERSION}-macos.zip"
...
cp "${PROJECT_ROOT}"/popup/*.css "${PROJECT_ROOT}"/popup/*.html "${PROJECT_ROOT}"/popup/*.js "${STAGE_DIR}/popup/"
